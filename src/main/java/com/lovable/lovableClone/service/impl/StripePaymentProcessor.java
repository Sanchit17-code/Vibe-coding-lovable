...
//                .setSuccessUrl(frontendUrl + "/success.html?session_id={CHECKOUT_SESSION_ID}")
        ...
        try {
            ...
            Session session = Session.create(params.build());  // this is where SDK is making the API call to the stripe server
...
//            throw new RuntimeException(e);
    ...
    public void handleWebhookEvent(String type, StripeObject stripeObject, Map<String, String> metadata) {
        ...
        switch (type) {
            ...
            case "invoice.paid" -> handleInvoicePaid((Invoice) stripeObject); // when invoice is paid - this is where access to the product is given
